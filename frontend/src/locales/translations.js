...
export const translations = {
  fr: {
    ...
    payment: {
      ...
      confirmed: "Confirme",
      amount: "Montant",
      errorPhoneInvalid: "Numero de telephone invalide. Format attendu : 6XXXXXXXX (MTN/Orange Cameroun)",
      errorPhoneEmpty: "Veuillez saisir un numero de telephone",
      errorPackageMissing: "Veuillez selectionner un forfait",
      errorNetwork: "Erreur reseau. Verifiez votre connexion et reessayez",
      errorGeneric: "Le paiement n'a pas pu etre initie",
      validateOnPhone: "Validez le paiement sur votre telephone"
    },
    licensing: {
      title: "Plans & Licences",
      subtitle: "Choisissez le plan qui correspond a votre activite agricole",
      ...
      featureUnlimited: "Illimite",
      featureIncluded: "Inclus",
      featureExcluded: "Non inclus",
      perMonth: "mois",
      perYear: "an",
      freeActivated: "Plan Gratuit active !",
      errorSubscribe: "Erreur lors de l'abonnement",
      errorLoad: "Erreur de chargement",
      gotoPay: "Rendez-vous sur la page Paiements pour finaliser via Mobile Money.",
      features: {
    ...
    support: {
      ...
      subtitle: "Posez vos questions, signalez un bug, demandez de l'aide.",
      newTicket: "Nouveau ticket",
      createTicket: "Creer un nouveau ticket",
      category: "Categorie",
      priority: "Priorite",
      slaHours: "reponse sous",
      hours: "h",
      subject: "Sujet",
      subjectPlaceholder: "Ex: Mon paiement Mobile Money n'aboutit pas",
      message: "Description detaillee",
      messagePlaceholder: "Decrivez votre probleme en detail. Plus vous donnez de contexte, plus vite nous pouvons vous aider.",
      attachments: "Pieces jointes (optionnel - max 3, 3 Mo chaque)",
      filesReady: "fichier(s) pret(s)",
      cancel: "Annuler",
      send: "Envoyer le ticket",
      noTickets: "Aucun ticket pour le moment",
      noTicketsCta: "Cliquez sur \"Nouveau ticket\" pour nous contacter",
      ...
      ticketClosed: "Ticket ferme",
      messageSent: "Message envoye",
      errorSubject: "Le sujet doit contenir au moins 3 caracteres",
      errorMessage: "Le message doit contenir au moins 10 caracteres",
      errorCreate: "Erreur lors de la creation",
      errorLoad: "Erreur de chargement",
      errorGeneric: "Erreur",
      statuses: { open: "Ouvert", in_progress: "En cours", resolved: "Resolu", closed: "Ferme" }
    },
    marketplaceV2: {
      confirmPurchase: "Confirmer l'achat",
      reviewOrder: "Verifiez votre commande avant de confirmer",
      product: "Produit",
      ...
      cancel: "Annuler",
      processing: "Traitement...",
      purchaseSuccess: "Achat confirme !",
  ...
  en: {
    ...
    payment: { title: "Subscription & Payment", selectPackage: "Select a package", payNow: "Pay now", processing: "Processing payment...", validatePhone: "Validate on your phone", success: "Payment Successful!", failed: "Payment Failed", retry: "Retry", history: "Payment History", operator: "Operator", phoneNumber: "Phone number", insufficientBalance: "Insufficient balance", confirmed: "Confirmed", amount: "Amount", errorPhoneInvalid: "Invalid phone number. Expected format: 6XXXXXXXX (MTN/Orange Cameroon)", errorPhoneEmpty: "Please enter a phone number", errorPackageMissing: "Please select a package", errorNetwork: "Network error. Check your connection and retry", errorGeneric: "Payment could not be initiated", validateOnPhone: "Validate the payment on your phone" },
    licensing: {
      title: "Plans & Licenses", subtitle: "Choose the plan that fits your farm",
      currentPlan: "Your current plan", free: "Free", active: "Active", expiresOn: "Expires on",
      monthly: "Monthly", annual: "Annual", save30: "-30%", current: "Current",
      activate: "Activate", subscribe: "Subscribe", processing: "Processing...",
      planCurrent: "Current plan", historyTitle: "Subscription history",
      featureUnlimited: "Unlimited", featureIncluded: "Included", featureExcluded: "Not included",
      perMonth: "month", perYear: "year", freeActivated: "Free plan activated!",
      errorSubscribe: "Subscription error", errorLoad: "Loading error",
      gotoPay: "Go to the Payments page to complete via Mobile Money.",
      features: {
        ai_analyses_per_month: "AI analyses per month", history_days: "History (days)",
        max_parcels: "Number of parcels", drone_missions: "Drone missions",
        api_access: "API access", priority_support: "Priority support",
        multi_user: "Multi-user", max_members: "Number of members", white_label: "White label"
      }
    },
    support: {
      title: "Support Center", subtitle: "Ask questions, report a bug, get help.",
      newTicket: "New ticket", createTicket: "Create a new ticket",
      category: "Category", priority: "Priority", slaHours: "response within", hours: "h",
      subject: "Subject", subjectPlaceholder: "Ex: My Mobile Money payment is not working",
      message: "Detailed description",
      messagePlaceholder: "Describe your issue in detail. More context = faster help.",
      attachments: "Attachments (optional - max 3, 3 MB each)", filesReady: "file(s) ready",
      cancel: "Cancel", send: "Send ticket",
      noTickets: "No tickets yet", noTicketsCta: "Click \"New ticket\" to contact us",
      messagesCount: "message(s)", yourReply: "Your reply...",
      closeTicket: "Close ticket", sendReply: "Send",
      youLabel: "You", supportLabel: "Support", attachmentLabel: "Attachment",
      ticketClosed: "Ticket closed", messageSent: "Message sent",
      errorSubject: "Subject must be at least 3 characters",
      errorMessage: "Message must be at least 10 characters",
      errorCreate: "Error creating ticket", errorLoad: "Loading error", errorGeneric: "Error",
      statuses: { open: "Open", in_progress: "In progress", resolved: "Resolved", closed: "Closed" }
    },
    marketplaceV2: {
      confirmPurchase: "Confirm purchase", reviewOrder: "Review your order before confirming",
      product: "Product", unitPrice: "Unit price", quantity: "Quantity",
      totalAmount: "Total amount", seller: "Seller", paymentMethod: "Payment method",
      mobileMoney: "Mobile Money", cashOnDelivery: "Cash on delivery",
      delivery: "Delivery", pickup: "Pickup", confirm: "Confirm purchase",
      cancel: "Cancel", processing: "Processing...",
      purchaseSuccess: "Purchase confirmed!", purchaseError: "Purchase error"
    }
  },
